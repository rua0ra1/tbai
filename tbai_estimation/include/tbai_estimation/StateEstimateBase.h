//
// Created by Ram Charan Thota on 6 January 2025
//
...
public:
  StateEstimateBase(PinocchioInterface pinocchioInterface,
                    CentroidalModelInfo info,
                    const PinocchioEndEffectorKinematics &eeKinematics);
  virtual void updateJointStates(const vector_t &jointPos,
  ...
  virtual vector_t update(const ros::Time &time,
...
protected:
  ...
  matrix3_t orientationCovariance_, angularVelCovariance_,
